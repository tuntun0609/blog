...
export function Pre({ className, ...props }: ComponentProps<"pre">) {
  return (
    <pre
      className={cn(
        "min-w-full w-max font-mono [&>code]:flex [&>code]:flex-col [&>code]:rounded-none [&>code]:bg-transparent [&>code]:p-0 [&>code]:text-[length:inherit]",
        className,
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      ...
      <section
        ...
        className={cn(
          "max-h-[600px] overflow-auto py-4 text-[0.8125rem] leading-6 outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring",
