...
先把鼠标停在左侧的“产品”上，再斜向右下方移动到子菜单。途中即使经过“解决方案”，当前子菜单也会保持打开。
...
`SAFE_OVERLAP` 让三角形起点稍微覆盖指针，避免指针刚好落在裁切边缘时离开命中区域。`safeY` 也被限制在子菜单高度以内，防止指针坐标超出矩形后生成异常形状。
